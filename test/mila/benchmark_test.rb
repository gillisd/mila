...
module Mila
  module Benchmark
    class BenchmarkTest < Minitest::Test
      ...
      def test_id
        json_file = Pathname('dumpsoftest.json')
      ...
      def create_session
        ...
        session.eval_inline do
          <<~JS
            ...
            function getId(obj) {
               return obj.modules.VLS.listing.listingClassification.product.autoTagEpid
            }
          JS
        end
        session
        ...
        ips(3) do |x|
          x.report('stock') do
            JSON.parse(string, symbolize_names: true)
                .dig(:modules, :VLS, :listing, :listingClassification, :product, :autoTagEpid)
          end
